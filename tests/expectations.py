...
EXPECTATIONS = [
    ...
    (
        ...
        [
            ...
            ("assert_neq", [[-1], ContractLogicError()], [[signed_int_to_felt(-1)], ContractLogicError()]),
            ("assert_neq", [[5], None], [[5], None]),
            ("assert_ge", [[-1], None], [[signed_int_to_felt(-1)], None]),
            ("assert_ge", [[-2**8], None], [[signed_int_to_felt(-2**8)], None]),
            ("assert_ge", [[-2**9], ContractLogicError()], [[signed_int_to_felt(-2**9)], ContractLogicError()]),
            ("assert_gt", [[-1], None], [[signed_int_to_felt(-1)], None]),
            ("assert_gt", [[-2**8], ContractLogicError()], [[signed_int_to_felt(-2**8)], ContractLogicError()]),
            ("assert_gt", [[-2**9], ContractLogicError()], [[signed_int_to_felt(-2**9)], ContractLogicError()]),
            ("assert_le", [[-1], ContractLogicError()], [[signed_int_to_felt(-1)], ContractLogicError()]),
            ("assert_le", [[-2**8], None], [[signed_int_to_felt(-2**8)], None]),
            ("assert_le", [[-2**9], None], [[signed_int_to_felt(-2**9)], None]),
            ("assert_lt", [[-1], ContractLogicError()], [[signed_int_to_felt(-1)], ContractLogicError()]),
            ("assert_lt", [[-2**8], ContractLogicError()], [[signed_int_to_felt(-2**8)], ContractLogicError()]),
